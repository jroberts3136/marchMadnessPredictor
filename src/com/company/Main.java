...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        Team [] d1Round1 = fileRead(fileName, fileSearch);             //Top left of bracket
        Team [] d2Round1 = fileRead(fileName, fileSearch);             //Bottom left of bracket
        Team [] d3Round1 = fileRead(fileName, fileSearch);             //Top right of bracket
        Team [] d4Round1 = fileRead(fileName, fileSearch);             //Bottom right of bracket
        ...
        Team [] d1d2Winners = new Team[2];
        Team [] d3d4Winners = new Team[2];
    ...
    public static Team determineWin (Team team1, Team team2){ //Return team with higher compare score, in case of tie, return better seed
    ...
    public static void round(Team[] round, Team[] next){
        int highSeed = 0;
    ...
    public static void round(Team[] division1, Team[]division2 , Team[] next){
        next[0] = determineWin(division1[0], division1[1]);
